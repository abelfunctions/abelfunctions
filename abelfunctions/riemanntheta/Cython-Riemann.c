/* Generated by Cython 0.15.1 on Wed Nov  7 20:47:12 2012 */
 ...
 *                                 <double*> np.PyArray_DATA(T),
 */
  if (!(likely(((__pyx_v_X) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_X, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = __pyx_v_X;
  __Pyx_INCREF(__pyx_t_4);

  /* "Cython-Riemann.pyx":57
 *     finite_sum_with_derivatives(real, imag,
 *                                 <double*> np.PyArray_DATA(X),
 *                                 <double*> np.PyArray_DATA(Yinv),             # <<<<<<<<<<<<<<
 *                                 <double*> np.PyArray_DATA(T),
 *                                 <double*> np.PyArray_DATA(x),
 */
  if (!(likely(((__pyx_v_Yinv) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_Yinv, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *                                 <double*> np.PyArray_DATA(y),
 */
  if (!(likely(((__pyx_v_T) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_T, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_2 = __pyx_v_T;
  __Pyx_INCREF(__pyx_t_2);
 ...
 */
  if (!(likely(((__pyx_v_y) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_y, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_6 = __pyx_v_y;
  __Pyx_INCREF(__pyx_t_6);
 ...
 */
  if (!(likely(((__pyx_v_S) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_S, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_7 = __pyx_v_S;
  __Pyx_INCREF(__pyx_t_7);
 ...
 *                                 nderivs, g, N)
 */
  if (!(likely(((__pyx_v_deriv_real) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_deriv_real, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     return real[0] + imag[0]*1.0j
 */
  if (!(likely(((__pyx_v_deriv_imag) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_deriv_imag, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_10 = __Pyx_PyInt_AsInt(__pyx_v_nderivs); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_11 = __Pyx_PyInt_AsInt(__pyx_v_g); if (unlikely((__pyx_t_11 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_12 = __Pyx_PyInt_AsInt(__pyx_v_N); if (unlikely((__pyx_t_12 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __pyx_t_9 = __pyx_PyComplex_FromComplex(__pyx_t_13); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
