...
double
exppart(int* n, double* X, double* x, int* intshift, int g)
{
    int tmp1[g];
    double tmp2[g];
    int i,j;
...
******************************************************************************/
double
normpart(int* n, double* T, double* fracshift, int g)
{
	                       ...
	                       int g, int N)
{
    ...
    */
    ...
    intshift = (int*)malloc(g*sizeof(int));
           ...
           int g)
{
    ...
    int *nmintshift;
    nmintshift = (int*)malloc(g*sizeof(int));
