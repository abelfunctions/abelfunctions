...
class TestNewtonPolygon(unittest.TestCase):
    ...
    def test_multiple(self):
        H = 2 * x**2 + 3 * x * y + 5 * y**3
        self.assertEqual(newton_polygon(H), [[(0, 2), (1, 1)], [(1, 1), (3, 0)]])
...
class TestNewtonData(unittest.TestCase):
    ...
    def test_colinear(self):
        ...
        self.assertEqual(newton_data(H), [(1, 1, 4, 7 * x**4 + 5 * x**2 + 3 * x + 2)])

        H = 2 * x**4 + 3 * x**2 * y**2 + 5 * x * y**3 + 7 * y**4
        self.assertEqual(
            newton_data(H), [(1, 1, 4, 7 * x**4 + 5 * x**3 + 3 * x**2 + 2)]
        )

    def test_multiple(self):
        H = 2 * x**2 + 3 * x * y + 5 * y**3
        self.assertEqual(newton_data(H), [(1, 1, 2, 3 * x + 2), (2, 1, 3, 5 * x + 3)])
    ...
    def test_general_to_colinear(self):
        ...
        self.assertEqual(newton_data(H), [(1, 1, 4, 7 * x**4 + 5 * x**2 + 3 * x)])

        H = 2 * x**5 + 3 * x**3 * y + 5 * x**2 * y**2 + 7 * y**6
        self.assertEqual(
            newton_data(H), [(1, 1, 4, 5 * x**2 + 3 * x), (2, 1, 6, 7 * x**2 + 5)]
        )
...
class TestPuiseux(AbelfunctionsTestCase):
    ...
    def test_PQ_f1(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(x**2, x**4 * (x * (y + 1) + 1))])
    ...
    def test_PQ_f2(self):
        ...
        self.assertCountEqual(
            series, [(x, x**2 * y), (-(x**2) / 2, -(x**3) * (y + 1) / 2)]
        )
    ...
    def test_PQ_f2_oo(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(1 / x**3, (x**2 * y + x**2) / x**9)])
    ...
    def test_PQ_f4(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(x, x * (y + 1)), (x, x * (y - 1))])
    ...
    def test_PQ_f4_oo(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(1 / (-(x**2)), (x * y + x) / x**4)])
    ...
    def test_PQ_f7(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(x, y + r0), (x, y + r1), (x, y + r2)])
    ...
    def test_PQ_f22(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(x**3, x**5 * (y + 1))])
    ...
    def test_PQ_f22_oo(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(1 / x**3, (x * y + x) / x**6)])
    ...
    def test_PQ_f23(self):
        ...
        y = QQbar["x,y"](y)
        self.assertCountEqual(
            series, [(x, x * (x * y + 2) + 1), (x, x * (x * (y + 1) + 2) + 1)]
        )
    ...
    def test_PQ_f23_oo(self):
        ...
        x = QQbar["x,y"](x)
        y = QQbar["x,y"](y)
        self.assertCountEqual(series, [(1 / x, y / x**7), (1 / x, (1 + y) / x**7)])
    ...
    def test_hyperelliptic_oo(self):
        ...
        y = QQbar["x,y"](y)
        self.assertCountEqual(
            series, [(1 / x, (y + 1) / x**3), (1 / x, (y - 1) / x**3)]
        )
